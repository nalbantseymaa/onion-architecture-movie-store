        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsersInGenreId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersGenres", x => new { x.FavoriteGenresId, x.UsersInGenreId });
                    table.ForeignKey(
                        name: "FK_UsersGenres_AspNetUsers_UsersInGenreId",
                        column: x => x.UsersInGenreId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersGenres_Genres_FavoriteGenresId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersGenres_UsersInGenreId",
                table: "UsersGenres",
                column: "UsersInGenreId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_RoleCheck", "Role IN ('Admin', 'Customer')");
                });
